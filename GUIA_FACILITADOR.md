...
|---|---|---|
| PASO 1 falla al instalar | “Colab no pudo preparar una librería; ahora veremos el detalle real.” | Comprueba internet y repite **PASO 1**. La nueva versión usa una carpeta aislada y solo tres dependencias. |
